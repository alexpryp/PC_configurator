...
$('document').ready(function () {
  var $chassisImgHolder = $('#imgHolder img'); // 1. Получение значения атрибута src у картинки

  var srcValue = $chassisImgHolder.attr('src'); // 2. Поменяем значение атрибута src у картинки
